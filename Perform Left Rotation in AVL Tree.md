...
class AVL_Tree(object):
	...
	def leftRotate(self, z):
	    ...
	    y.height=1+max(self.getHeight(z.left),self.getHeight(z.right))
	    return y
...
## OUTPUT
![Screenshot 2025-05-18 185730](https://github.com/user-attachments/assets/0a3f84da-683c-41a7-82b8-627cf7856e56)

## RESULT
Thus the python program to perform the left rotation operation in an AVL Tree and insert the element '7' into it has been implemented and executed.
